...
## 1. OpenCV란?
**OpenCV(Open Source Computer Vision Library)** 는 컴퓨터가 이미지나 영상을 이해하고 처리할 수 있게 도와주는 오픈소스 라이브러리입니다.
